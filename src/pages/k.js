...
// import PengaduanList from "../components/masyarakat/PengaduanList"
// import { base_url, pengaduan_foto_url } from "../config.js";
// import $ from "jquery"
// import axios from "axios"

// export default class UserPengaduan extends React.Component{
//     constructor(){
//         super()
//         this.state = {
//             aduan: [],
...
// // //                           <h6>Nama Masyarakat : {(this.state.selectedPengaduan !== null) ? this.state.selectedPengaduan.masyarakat.nama: null} </h6>
// // //                           <h6>Laporan : {(this.state.selectedPengaduan !== null) ? this.state.selectedPengaduan.isi_laporan: null} </h6>
// // //                           <h6>Tanggapan : {(this.state.selectedPengaduan !== null) ? (this.state.selectedPengaduan.tanggapan !== null ? this.state.selectedPengaduan.tanggapan.tanggapan : "-") : null} </h6>                          <h6>Status : {(this.state.selectedPengaduan !== null) ? this.state.selectedPengaduan.status : null}</h6>
// // //                           </div>
// // //                       </div>
// // //                   </div>
// // //               </div>
